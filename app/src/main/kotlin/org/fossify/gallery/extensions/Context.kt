...
fun Context.loadImageBase(
    ...
    if (roundCorners != ROUNDED_CORNERS_NONE) {
        val cornerSize =
            if (roundCorners == ROUNDED_CORNERS_SMALL) org.fossify.commons.R.dimen.rounded_corner_radius_small else R.dimen.dir_grid_corner_radius
...
fun Context.loadSVG(
    ...
    if (roundCorners != ROUNDED_CORNERS_NONE) {
        val cornerSize = when (roundCorners) {
            ...
            else -> R.dimen.dir_grid_corner_radius
        }
