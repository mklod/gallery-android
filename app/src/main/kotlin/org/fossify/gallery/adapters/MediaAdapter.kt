...
class MediaAdapter(
    ...
    private fun setupThumbnail(view: View, medium: Medium) {
        ...
        bindItem(view, medium).apply {
            ...
            if (isListViewType) {
                videoDuration?.setTextColor(0xFFFFFFFF.toInt())
            }

            mediumCheck.beVisibleIf(isSelected)
            if (isSelected) {
                mediumCheck.background?.applyColorFilter(0xFFFFFFFF.toInt())
                mediumCheck.applyColorFilter(0xFF000000.toInt())
            }
            ...
            if (isListViewType) {
                mediumName.setTextColor(0xFFFFFFFF.toInt())
                playPortraitOutline?.applyColorFilter(0xFFFFFFFF.toInt())
            }
        }
    }
    ...
    private fun setupSection(view: View, section: ThumbnailSection) {
        ThumbnailSectionBinding.bind(view).apply {
            ...
            thumbnailSection.setTextColor(0xFFFFFFFF.toInt())
        }
    }
